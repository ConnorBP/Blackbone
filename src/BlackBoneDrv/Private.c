...
VOID InitializeDebuggerBlock()
{
    ...
    PDUMP_HEADER dumpHeader = ExAllocatePool2( NonPagedPool, DUMP_BLOCK_SIZE, BB_POOL_TAG );
    if (dumpHeader)
    {
...
PVOID GetKernelBase( OUT PULONG pSize )
{
    ...
    pMods = (PRTL_PROCESS_MODULES)ExAllocatePool2( NonPagedPool, bytes, BB_POOL_TAG );
